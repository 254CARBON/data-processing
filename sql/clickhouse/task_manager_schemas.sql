-- Task Manager ClickHouse schemas for 254Carbon platform
-- Tables for RFTP intake, task proposals, approvals, and billing workflows
...
-- Task Progress History table (for tracking changes over time)
...
-- Task Summary table (destination for materialized view)
...
-- Budget Alerts View (for monitoring 70% spend threshold)
...
-- Budget Alerts table (destination for materialized view)
